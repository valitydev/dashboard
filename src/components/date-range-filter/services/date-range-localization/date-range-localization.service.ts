...
export class DateRangeLocalizationService {
    private translations$ = this.transloco.selectTranslation('core-components').pipe(map(() => this.getPartLabels()));
    ...
    private getPartLabels(): Record<typeof DATE_RANGE_WORDS[number], string> {
        return {
            ...
            fromStartWith2: this.transloco.translate('dateRangeFilter.part.fromStartWith2', null, 'core-components'),
            to: this.transloco.translate('dateRangeFilter.part.to', null, 'core-components'),
            currentWeek: this.transloco.translate('dateRangeFilter.part.currentWeek', null, 'core-components'),
